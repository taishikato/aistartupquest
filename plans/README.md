...
| 002 | Add anti-abuse protection to company submission requests | P1 | M | - | IN PROGRESS |
...
- 2026-07-11 at `643a83b` (`/improve execute 003`): plan refreshed before dispatch (Step 1 lint fix dropped — `events-world-map.tsx` deleted; lint already clean). Executor landed timezone edge tests, submit-helper tests, and `.github/workflows/ci.yml` on `advisor/003-verification-baseline`. Reviewer re-ran lint/typecheck/test/YAML parse; scope clean; APPROVED. Not merged/pushed.
